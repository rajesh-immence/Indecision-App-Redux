...
import CreatePolicy from 'src/pages/dashboard/CreatePolicy';
import EditPolicy from 'src/pages/dashboard/EditPolicy';

import { Policies } from 'src/pages/dashboard/Policies';
// auth
  ...
  return useRoutes([
    ...
    // Dashboard
    {
      ...
      children: [
        ...
        { path: 'edit/:id', element: <EditPolicy /> },
