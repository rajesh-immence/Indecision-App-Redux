...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    subheader: 'general',
    items: [
      { title: 'policies', path: PATH_DASHBOARD.general.policies, icon: ICONS.policies },
      { title: 'create', path: PATH_DASHBOARD.general.create, ICONS: ICONS.policies },
      { title: 'edit', path: PATH_DASHBOARD.general.demoEdit },
